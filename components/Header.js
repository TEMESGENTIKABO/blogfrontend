...
const Header = () => {
  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem>
        <Button sx={{ color: "#1c1c1c" }} href="/blogs">
          Blogs
        </Button>
      </MenuItem>
      <MenuItem>
        <Button sx={{ color: "#1c1c1c" }} href="/contact">
          {" "}
          Contact Us
        </Button>
      </MenuItem>
      ...
      {isAuth() && isAuth().role === 1 && (
        <MenuItem>
          <Button sx={{ color: "#1c1c1c" }} href="/admin">
            {" "}
            {`${isAuth().name}'s Dashboard`}
          </Button>
        </MenuItem>
      ...
      <MenuItem>
        <Button sx={{ color: "#1c1c1c" }} href="/user/crud/blog">
          Write a blog
        </Button>
      </MenuItem>
      <MenuItem>
        <Button sx={{ color: "#1c1c1c" }} href="/aboutus">
          {" "}
          About Us
        </Button>
      </MenuItem>
            ...
            <Toolbar>
              ...
              >
                <SearchIcon
                  fontSize="large"
                  color="primary"
                  sx={{ marginLeft: 3, marginRight: 3, color: "#212121" }}
                />
              ...
              <Button
                aria-describedby={idAccountLabel}
                onClick={handleClickAccountLabel}
                color="inherit"
                sx={{
                  display: "flex",
                  flexDirection: "column",
              ...
              <Popper
                id={idAccountLabel}
                open={openAccountLabel}
                anchorEl={anchorAccountLabel}
                transition
              >
                {({ TransitionProps }) => (
