    ...
    <Head>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <meta
            name="description"
            content={`Gloom|Find What you want| Latest Blogs,Latest Articles,Latest News on  ${category.name} `}
          />
          <link rel="canonical" href={`${DOMAIN}/categories/${query.slug}`} />
          <meta
            property="og:title"
            content={`Gloom|Find What you want| Latest Blogs,Latest Articles,Latest News on ${category.name}| ${APP_NAME}`}
          />
          <meta
