...
const MediumEditor = dynamic(() => import("../../Editor/Readdata"), {
  ssr: false,
});
          ...
          <main>
            <article>
              ...
              <div className="container">
                <section>
                  {JSON.parse(blog.body).editor === "Editorjs" && (
                    <MediumEditor
                      value={JSON.parse(JSON.parse(blog.body).body)}
                    />
                  )}
                  ...
                  {JSON.parse(blog.body).editor === "Quill" && (
                    <div className="col-md-12 lead">
                      {" "}
                      <Typography
                        style={{ color: "#595855", wordBreak: "break-word" }}
                      >
                        {/* style={{ color: '#595855' }}  */}
                    ...
                    <div className="col-md-12 lead">
                      <div
                        dangerouslySetInnerHTML={{
                          __html: JSON.parse(blog.body).body,
                        }}
                      />
                    </div>
                  )}
